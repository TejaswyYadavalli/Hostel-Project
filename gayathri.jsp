                    ...
                    <div id="content">
                        ...
                        <div id="ground_floor">
                            ...
                            <div class="seat-allotment">
                                <p>NAME: <span> Gayathri Hostel</span></p>
                                <p>TYPE: <span> Girls</span></p>
                            ...
                            <form action="gayathriDB.jsp" method="post" name="bedLayout" onsubmit="return rollNo()">
                                <div id="allot">

                                    <%

                                        PreparedStatement ps = con.prepareStatement("select *from gayathri where floorno=?");
                                        ps.setInt(1, 0);
                        ...
                        <div id="first_floor" style="margin-left: 100px;">
                            ...
                            <form action="gayathriDB.jsp" method="post" name="bedLayout1" onsubmit="return rollNo1()">
                                <div id="allot">

                                    <%
                                        PreparedStatement ps1 = con.prepareStatement("select *from gayathri where floorno=?");
                                        ps1.setInt(1, 1);
                        ...
                        <div id="second_floor" style="margin-left: 100px;">
                            ...
                            <form action="gayathriDB.jsp" method="post" name="bedLayout2" onsubmit="return rollNo2()">
                                <div id="allot">

                                    <%
                                        PreparedStatement ps3 = con.prepareStatement("select *from gayathri where floorno=?");
                                        ps3.setInt(1, 2);
