                ...
                <body>
                    ...
                    <div id="content" style="margin-left: 100px;" >
                        ...
                        <div class="seat-allotment">
                            <p>NAME: <span> Krishna Hostel</span></p>
                        ...
                        <form action="krishnaDB.jsp" method="post" name="bedLayout" onsubmit="return rollNo()">
                            <div id="allot"  >

                                <%
                                    Connection con = DB.getConnection();
                                    PreparedStatement ps = con.prepareStatement("select *from krishna");
