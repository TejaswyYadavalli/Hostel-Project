                ...
                <body>
                    ...
                    <div id="content" style="margin-left: 100px;">
                        ...
                        <div class="seat-allotment">
                            <p>NAME: <span> Kinnera Hostel</span></p>
                        ...
                        <form action="kinneraDB.jsp" method="post" name="bedLayout" onsubmit="return rollNo()">
                            <div id="allot">

                                <%
                                    Connection con = DB.getConnection();
                                    PreparedStatement ps = con.prepareStatement("select *from kinnera");
