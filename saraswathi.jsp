                    ...
                    <div id="content">
                        <div id="ground_floor">
                            ...
                            <div class="seat-allotment">
                                <p>NAME: <span> Saraswathi Hostel</span></p>
                            ...
                            <form action="saraswathiDB.jsp" method="post" name="bedLayout" onsubmit="return rollNo()">
                                <div id="allot">

                                    <%
                                        Connection con = DB.getConnection();
                                        PreparedStatement ps = con.prepareStatement("select *from saraswathi");
